...
During calibration, the library also computes quantities used to explore posterior multimodality with density-based clustering ideas, and in particular Density-Peak Clustering (DPC) [4].
...
- **`point_estimate_partition`**: array of length `n`
